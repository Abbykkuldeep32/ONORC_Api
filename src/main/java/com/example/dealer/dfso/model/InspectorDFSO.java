...
@Entity
@Table(name = "onorc_insp_detail_by_dfso")
public class InspectorDFSO {
	...
	public InspectorDFSO(String inspectorcode, String statecode, String statename, String lgddistrictcode,
			String districtname, String lgdtehsilcode, String tehsilname, String dfsocode, String dfsoname,
			String afsocode, String afsoname, String inspectorname, String mobileno, String inspectornamell,
