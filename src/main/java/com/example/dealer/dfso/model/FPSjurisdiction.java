...
public class FPSjurisdiction {
	...
	public FPSjurisdiction(String fpsid, String statename, String license_no, String fpstype, String area_type,
			String district, String fps_operation_name, String fpsname, String fpsowner, String gender, int age,
			String address, String tehsilname, String villagename, String mobile_no, Date issuedate,
			Date fps_validity_upto, Double latitute, Double longitute, Double accuracy, String fps_owner_father_name,
			String pincode, String fps_nomine_name, String fps_nomine_mobile_no, String fps_nomine_father_name,
			String fps_auth_type) {
		super();
		this.fpsid = fpsid;
		this.statename = statename;
		this.license_no = license_no;
