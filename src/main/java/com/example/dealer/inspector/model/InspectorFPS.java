...
@Entity
@Table(name = "onorc_fps_data_inspector")
public class InspectorFPS {
	...
	public InspectorFPS(String fpsid, String statecode, String districtcode, String lgd_state_code,
			...
			String fps_operation_name, Date issuedate, Date fps_validity_upto, String fpsname, String fpsowner,
			String gender, String age, String address, String tehsilname, String villagename, String mobile_no,String lattitude,
			String longitude, String accuracy, String fps_owner_father_name, String pincode, String fps_nomine_name,
			String fps_nomine_mobile_no, String fps_nomine_father_name, String fps_auth_type, String inspectorcode,
			String inspectorname, String godownid, String godownname) {
		super();
		this.fpsid = fpsid;
		this.statecode = statecode;
		this.districtcode = districtcode;
